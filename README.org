...
* Fast Install
  ...
  *PREREQUISITES*: You need to have installed Python with modules /webpy/,
  ...
  in a sqlite database. You have the /trufa-users-sqlite/ module already
  available in this repository inside of the /users/ folder. You can use it
  pointing ~USERS_LIB~ to the parent folder of /users/ folder.
